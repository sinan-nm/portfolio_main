...
const Hero = () => {
  return (
    ...
    >
      ...
      >
        <motion.p
          className="text-green-400 font-mono tracking-[0.3em] uppercase text-xs sm:text-sm mb-4"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
    ...
    >
        ...
        <motion.p
          className="text-sm sm:text-lg md:text-xl text-gray-400 font-light tracking-widest uppercase"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
